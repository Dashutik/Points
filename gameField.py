            ...
            for j in range(self.grid_size):
                ...
                if self.grid[i][j] is not None:
                    if 0.5 <= self.grid[i][j] <= 0.53:
                        ...
                        player_index = int(self.grid[i][j]) if int(self.grid[i][j]) < len(self.players) else -1
                        if player_index != -1:
                            color = self.players[player_index]
